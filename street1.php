...
<title>Yi Chen Photography | Seattle  Stock and Advertisement Photographer</title>
<link href="style/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
<?php include("header.php"); ?>
<div id="content">
  <div id="photo"> <?php echo '<img src="street/street'.$_REQUEST['id'].'.jpg" class="imgb"/>'; ?><img src="street/street1.jpg" class="imgb"/>
	<div id="description"></div> 
  </div>
<?php include("street_thumbnail_1.php");?>
</div>
