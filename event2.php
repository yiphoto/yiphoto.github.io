...
<title>Yi Chen Photography | Seattle  Event Photographer</title>
...
<div id="content">
  ...
  {
  echo '<img src="event/event'.$_REQUEST['id'].'.jpg" class="imgb"/>';   
  }
  else
  {
  echo '<img src="event/event11.jpg" class="imgb" />';
  }
  ?>
	<div id="description"></div> 
  </div>
<?php include("event_thumbnail_2.php");?>
</div>
