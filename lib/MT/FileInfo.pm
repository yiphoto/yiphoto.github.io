# Copyright 2003-2004 Six Apart. This code cannot be redistributed
# without permission from www.sixapart.com.  
#
# $Id: FileInfo.pm,v 1.8 2004/08/28 21:34:09 ezra Exp $
...
__PACKAGE__->install_properties({
    columns => [
        'id', 'blog_id', 'entry_id', 'url', 'file_path',
        'templatemap_id', 'template_id', 'archive_type',
        'category_id', 'startdate', 'virtual'
    ],
    indexes => {
        blog_id => 1,
        entry_id => 1,
