...
<body>
<?php 	if (!isset($submit)){
	echo "<FORM ACTION=\"emailfaq.php\" METHOD=\"POST\">";
	...
	$query = "SELECT title, content FROM ".$dbprefix."faqcont WHERE artid=$id";
