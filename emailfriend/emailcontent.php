...
<body>
<?php 	if (!isset($submit)){
	echo "<FORM ACTION=\"emailcontent.php\" METHOD=\"POST\">";
	...
	$title =eregi_replace($pat, $replace, $heading);
	$title =eregi_replace($pat, $replace, $heading);
	...
	$message = "<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.0 Transitional//EN'>\n
			<html>\n
			  ...
			  <body>\n
				...
				<TR>\n
	    			<TD CLASS=\"articlehead\" COLSPAN=\"2\">$heading</TD>\n
				</TR>\n
				<TR>\n
