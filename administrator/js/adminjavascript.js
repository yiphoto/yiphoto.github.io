...
*	03-02-2003
*
*	Copyright (C) 2000 - 2001 Miro International Pty. Limited
...
function submitbutton(pressbutton, section){
	switch (section){
		...
		break;
		case "news":
			if ((document.adminForm.mytitle.value == "") || (document.adminForm.newscatid.value == "") || (document.adminForm.introtext.value == "")){
