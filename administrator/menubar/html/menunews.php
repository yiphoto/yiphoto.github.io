...
class menunews {
			...
			<TR>
				...
				<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
					...
					<TR>
						...
						<TD WIDTH="50" ALIGN='center' BGCOLOR="#999999" VALIGN="bottom"><A HREF="index2.php?option=News&categories=<?php echo $categories; ?>" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('cancel','','../images/admin/cancel_f2.gif',1);"><IMG SRC="../images/admin/cancel.gif" ALT="Cancel" WIDTH="34" HEIGHT="47" BORDER="0" NAME="cancel" HSPACE="5" VSPACE="0"></A></TD>
						<TD WIDTH="470">&nbsp;</TD>
					</TR>
					</TABLE>
				</TD>
		...
		function EDIT_MENU_News($database, $dbprefix, $comcid, $option, $categories){
			$query = "SELECT published, archived, approved FROM ".$dbprefix."stories WHERE sid='$comcid'";
					...
					<TR>
						<?php if ($approved==1){
							...
							<?php }
								...
								<td width="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><a href="javascript:submitbutton('approve', 'news');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('approve','','../images/admin/approve_f2.gif',1);" ><img name="approve" src="../images/admin/approve.gif" width="38" ALT="Approve" HEIGHT="47" border="0" HSPACE="5" VSPACE="0"></a></td>
						...
						<?php }?>
								...
								<TD WIDTH="50" ALIGN='center' BGCOLOR="#999999" VALIGN="bottom"><A HREF="#" onClick="window.open('gallery/gallery.php', 'win1', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('uploadPic','','../images/admin/uploadPic_f2.gif',1);"><IMG SRC="../images/admin/uploadPic.gif" ALT="Upload Image" WIDTH="35" HEIGHT="47" BORDER="0" name="uploadPic" HSPACE="5" VSPACE="0"></A></TD>
								<TD WIDTH="50" ALIGN='center' BGCOLOR="#999999" VALIGN="bottom"><A HREF="menubar/cancel.php?id=<?php echo $comcid; ?>&option=<?php echo $option; ?>&categories=<?php echo $categories; ?>" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('cancel','','../images/admin/cancel_f2.gif',1);"><IMG SRC="../images/admin/cancel.gif" NAME="cancel" ALT="Cancel" WIDTH="34" HEIGHT="47" BORDER="0" HSPACE="5" VSPACE="0"></A></TD>
								<TD WIDTH="270">&nbsp;</TD>
					</TR>
					</TABLE>
				</TD>
			...
			<TR>
				...
				<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
					...
					<TR>
						...
						<TD WIDTH="50" ALIGN='center' BGCOLOR="#999999" VALIGN="bottom"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a news story to archive'); } else {submitbutton('archive', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('archive','','../images/admin/archive_f2.gif',1);"><IMG SRC="../images/admin/archive.gif" ALT="Archive" WIDTH="35" ALT="Archive" HEIGHT="47" BORDER="0" NAME="archive" HSPACE="5" VSPACE="0"></A></TD>
						...
						<TD WIDTH="50" BGCOLOR="#999999" VALIGN="bottom" ALIGN="center"><A HREF="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select a news story to edit'); } else {submitbutton('edit', '');}" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('edit','','../images/admin/edit_f2.gif',1);"><IMG SRC="../images/admin/edit.gif" NAME="edit" ALT="Edit" WIDTH="34" HEIGHT="47" BORDER="0" HSPACE="5" VSPACE="0"></A></TD>			    
