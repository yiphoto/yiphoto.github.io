		...
		function menussystemInfo(){ ?>
			...
			<TR>
				...
				<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
					...
					<TR>
			    		<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript: submitbutton('save', 'systemInfo');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('save','','../images/admin/save_f2.gif',1);"><IMG SRC="../images/admin/save.gif" ALT="Save" WIDTH="34" HEIGHT="47" BORDER="0" NAME="save" HSPACE="5" VSPACE="0"></A></TD>
						<TD WIDTH="370">&nbsp;</TD>
					</TR>
					</TABLE>
				</TD>
