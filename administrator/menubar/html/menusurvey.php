...
class menusurvey {
		...
		function EDIT_MENU_Survey($comcid, $database, $dbprefix){
			$query = "SELECT published FROM ".$dbprefix."poll_desc WHERE pollID='$comcid'";
			...
			<TR>
				...
				<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
					...
					<?php 	if ($publish == "1"){?>
						...
						<TD WIDTH="50" ALIGN='center'><A HREF="#" onclick="javascript:window.open('popups/surveywindow.php?id=<?php echo $comcid; ?>', 'win1', 'status=no,toolbar=no,scrollbars=auto,titlebar=no,menubar=no,resizable=yes,width=200,height=400,directories=no,location=no');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('preview','','../images/admin/preview_f2.gif',1);"><IMG SRC="../images/admin/preview.gif" ALT="Preview" WIDTH="35" HEIGHT="47" BORDER="0" NAME="preview" HSPACE="5" VSPACE="0"></A></TD>
						<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript:submitbutton('saveedit', 'survey');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('save','','../images/admin/save_f2.gif',1);"><IMG SRC="../images/admin/save.gif" ALT="Save" WIDTH="36" HEIGHT="47" BORDER="0" NAME="save" HSPACE="5" VSPACE="0"></A></TD>
			    		<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript:document.location.href='menubar/cancel.php?id=<?php echo $comcid; ?>&option=Survey'" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('cancel','','../images/admin/cancel_f2.gif',1);"><IMG SRC="../images/admin/cancel.gif" ALT="Cancel" WIDTH="34" HEIGHT="47" BORDER="0" NAME="cancel" HSPACE="5" VSPACE="0"></A></TD>
						<TD WIDTH="370">&nbsp;</TD>
					</TR>
					</TABLE>
				</TD>
