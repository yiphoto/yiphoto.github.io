...
#
# $Id: ConfigMgr.pm,v 1.97 2004/10/06 07:00:32 hirata Exp $
...
sub init {
    ...
    $mgr->define('IgnoreISOTimezones', Default => 0);
    ...
    $mgr->define('AdminScript', Default => 'mt.cgi');
    ...
    $mgr->define('AtomScript', Default => 'mt-atom.cgi');
    ...
    $mgr->define('AltTemplate', Type => 'ARRAY');
    $mgr->define('SearchSortBy');
    $mgr->define('SearchSortOrder', Default => 'ascend');
    $mgr->define('RegKeyURL', Default => 
		 'http://www.typekey.com/extras/regkeys.txt');
    $mgr->define('SignOnURL', Default => 
		 'https://www.typekey.com/t/typekey/login?');
    $mgr->define('SignOffURL', Default => 
		 'https://www.typekey.com/t/typekey/logout?');
    $mgr->define('IdentityURL', Default => "http://profile.typekey.com/");
    $mgr->define('DynamicComments', Default => 0);
    $mgr->define('SignOnPublicKey', Default => '');
    $mgr->define('ThrottleSeconds', Default => 20);
    $mgr->define('OneHourMaxPings', Default => 10);
    $mgr->define('OneDayMaxPings', Default => 50);
    $mgr->define('NewsboxURL',
		 Default => 'http://www.movabletype.org/news/newsbox.html');
    $mgr->define('EmailAddressMain');
    $mgr->define('EmailVerificationSecret');
    $mgr->define('CommentSessionTimeout', Default => 60 * 60 * 1);
    $mgr->define('LaunchBackgroundTasks', Default => 1);
    $mgr->define('TypeKeyVersion', Default => 1);
    $mgr->define('TransparentProxyIPs', Default => 0);
}
